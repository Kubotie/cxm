...
import { fetchAllCompanies, fetchAlerts } from "@/lib/nocodb-client";
import type { AppCompany, AppAlert } from "@/lib/nocodb-client";
                    ...
                    {outboundCandidates.map((outbound) => (
                      <div key={outbound.id} className="border rounded-lg p-3">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Link href={`/outbound/compose?id=${outbound.id}`}>
                    ...
                    {workflowCandidates.map((item) => (
                      <div key={item.id} className="border rounded-lg p-3">
                        ...
                        <div className="flex items-center justify-end">
                          <Link href={item.type === "action" ? "/actions" : "/content"}>
                            <Button variant="ghost" size="sm" className="text-xs h-7">
