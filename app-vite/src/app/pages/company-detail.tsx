...
import { fetchCompanyByUid, fetchAlerts, fetchEvidence, fetchPeople } from "../../services/nocodb";
import type { AppCompany, AppAlert, AppEvidence, AppPerson } from "../../services/nocodb";
    ...
    <div className="flex h-screen bg-slate-50">
            ...
            <div className="max-w-[1800px] mx-auto">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link to={`/companies/${companyId}/log`}>
                    <Button variant="outline" size="sm" className="h-7 text-xs">
                  ...
                  <div className="p-4 space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        {/* 主CTA: Company施策導線 */}
                        <div className="space-y-2">
                          <Link to={`/outbound/compose?sourceContext=company&linkedCompany=${company.id}&companyName=${encodeURIComponent(company.name)}&phase=${company.phaseLabel}`}>
                        ...
                        {/* 補助CTA: 業務文脈へ */}
                        <div className="space-y-2">
                          <Link to={`/actions?context=company&id=${company.id}`}>
                            <Button variant="outline" size="sm" className="w-full text-xs h-8 justify-start">
                              <CheckSquare className="w-3 h-3 mr-2" />
                              Actionsに送る
                            </Button>
                          </Link>
                          <Link to={`/content?context=company&id=${company.id}`}>
                            <Button variant="outline" size="sm" className="w-full text-xs h-8 justify-start">
                        ...
                        {/* 補助CTA: 参照 */}
                        <div className="space-y-2">
                          <Link to={`/unified-log?company=${company.id}`}>
                            <Button variant="outline" size="sm" className="w-full text-xs h-8 justify-start">
      ...
      <Sheet open={showSalesforceSyncSheet} onOpenChange={setShowSalesforceSyncSheet}>
        <SheetContent className="w-[700px] sm:max-w-[700px]">
          ...
          <div className="flex gap-2 mt-4 px-4">
            <Link 
              to={`/outbound/compose?fromCompany=${company.id}&sync=salesforce&type=org_chart`}
              className="flex-1"
            >
              <Button
                variant="default"
