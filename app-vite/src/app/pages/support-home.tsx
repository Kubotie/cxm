  ...
  return (
    <div className="fixed inset-y-0 right-0 w-[480px] bg-white shadow-2xl border-l z-50 flex flex-col overflow-hidden">
      ...
      <div className="p-4 border-t flex gap-2">
        {alert.companyId && (
          <Link to={`/companies/${alert.companyId}`} className="flex-1">
        ...
        <Link to="/support/queue" className="flex-1">
...
export function SupportHome() {
  ...
  let filtered = ALERTS.filter((a) => {
    if (quickFilter === "untriaged") return a.status === "Untriaged";
    if (quickFilter === "urgent") return a.priority === "Critical";
    if (quickFilter === "risk") return a.alertType === "Risk";
    if (quickFilter === "opportunity") return a.alertType === "Opportunity";
    return true;
  });
        ...
        <main className="flex-1 overflow-auto">
          <div className="max-w-[1800px] mx-auto p-6 space-y-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-slate-400 ml-2">{filtered.length}件</span>
            </div>
